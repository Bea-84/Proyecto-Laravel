                    ...
                    <DataTable :value="actividades">
                        ...
                        <Column header="Acciones">
                            <template #body="slotProps">
                                <!-- Botón para editar Actividad que le pasaremos a la vista edit los datos a través de su id-->
                                <router-link :to="{ name: 'actividad.edit', params: { id: slotProps.data.id } }"
                                ...
                                <Button @click="confirm1($event, slotProps.data.id, slotProps.index)"
...
const deleteActividad = (id, index) => {

    axios.delete(`/api/actividad/${id}`)
        .then(response => {
            console.log("Actividad eliminado:", response.data);
            // Mostrar index del array sin el dato eliminado
            Actividad.value.splice(index, 1);
