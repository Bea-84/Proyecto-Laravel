            ...
            <div class="col-lg-12">
                <div class="card ">
                    <div class="d-flex justify-content-between pb-2 mb-2">
                        <h5 class="card-title  text-uppercase"><strong>Clases registradas</strong></h5>
                    ...
                    <DataTable :value="clase" tableStyle="min-width: 50rem" class="border border-black p-3">
                         ...
                         <router-link
                                :to="{ name: 'clase.edit', params: { id: slotProps.data.id } }" class="btn btn-dark">
                        ...
                        <Button @click="confirm1($event,slotProps.data.id, slotProps.index)"  class="btn btn-dark">
